  ...
  return (
    <ThemeProvider>
      <RadioProvider profile={activeProfile} setProfile={setProfile}>
        ...
        {(currentView === "sidewalk" || !isClubRoute) ? (
          <Sidewalk 
            onEnterClub={() => {
              setCurrentView("club");
          ...
          <>
            ...
            {!session ? (
              ...
              /* Inside the Club (Authorized) */
              <div className="h-dvh relative z-10 flex flex-col overflow-y-auto overflow-x-hidden bg-zinc-950 text-white w-full custom-scrollbar">
                    ...
                    {updateAvailable && (
                      <div className="fixed top-0 left-0 right-0 z-9999 p-4 flex justify-center pointer-events-none animate-fade-in-down">
                        <div className="bg-zinc-900 border border-purple-500/50 shadow-[0_0_30px_rgba(168,85,247,0.3)] rounded-2xl p-4 flex items-center gap-4 pointer-events-auto max-w-sm w-full">
                          ...
                          <div className="grow">
                            <h3 className="text-white text-[12px] font-black uppercase tracking-wider mb-0.5">Station Update Ready</h3>
                            <p className="text-zinc-400 text-[10px] font-medium leading-tight">A new version of Club Youniverse Live is available. Update now to refresh the airwaves.</p>
                          </div>
                          <button
